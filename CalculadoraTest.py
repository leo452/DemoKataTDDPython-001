...
class CalculadoraTest(TestCase):
    ...
    def test_sumarCadenaConNumero(self):
        self.assertEqual(Calculadora().sumar("1"),1,"Un numero")
    ...
    def test_sumar_cadenaConMultiplesNumeros(self):
        self.assertEqual(Calculadora().sumar("5,4,2,1"),12,"Multiples numeros")

    def test_sumarCadenaConMultiplesNumerosConSeparadores(self):
